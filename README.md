...
An event scheduling app for people who want to meet up but find it hard to decide a time that suits the most participants.

Users can create an event with multiple potential time slots and invite their friends to vote on their preferred slots.
